...
def generate_from_channel_if_new(
    ...
    use_generated_fallback: bool = typer.Option(True, help="Allow using YouTube autogenerated captions when manual transcripts are unavailable"),
    ytdlp_cookies_file: Optional[str] = typer.Option(None, help="Path to cookies.txt for yt-dlp fallback (optional)"),
    ytdlp_cookies_from_browser: Optional[str] = typer.Option(None, help="Browser spec for yt-dlp cookies (e.g., chrome:default) (optional)"),
) -> None:
    ...
    # Wire cookies to env for fallback if provided
    if ytdlp_cookies_file:
        os.environ["YTDLP_COOKIES_FILE"] = ytdlp_cookies_file
    if ytdlp_cookies_from_browser:
        os.environ["YTDLP_COOKIES_FROM_BROWSER"] = ytdlp_cookies_from_browser
