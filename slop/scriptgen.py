...
def generate_scenes(
    *,
    ...
    user_msg = (
        ...
        "Ponadto zastosuj się do poniższej instrukcji tematycznej (bez zmiany zasad długości i struktury):\n"
        ...
        "Zachowaj spójność stylistyczną i klarowność. Unikaj nawiązań do wcześniejszych stałych list dat, postaci i instytucji; trzymaj się wyłącznie bieżącego tematu. "
